...
const AIEngine = {
  ...
  getAIPlatforms() {
    return [
      { id: 'mimo',      name: '小米 Mimo',   icon: '🟠', url: 'https://mimo.xiaomi.com/',                   color: '#ff6900' },
      { id: 'openrouter', name: 'OpenRouter',  icon: '🟣', url: 'https://openrouter.ai/chat',                 color: '#7c3aed' },
      { id: 'chatgpt',   name: 'ChatGPT',     icon: '🟢', url: 'https://chat.openai.com/',                    color: '#10a37f' },
      { id: 'claude',    name: 'Claude',      icon: '🔵', url: 'https://claude.ai/new-chat',                 color: '#4f8df7' },
